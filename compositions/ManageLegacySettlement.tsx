...
export const ManageLegacySettlement: React.FC<ManageSettlementProps> = (
  ...
  const {handleTx: handleCheapTx, txStatus: cheapTxStatus, txInProgress: cheapIp} = useContractTransaction(1)
    ...
    <div>
      {!approved ?
        ...
        <div style={{marginBottom: 20}}>
          ...
          {!txInProgress &&
          <button onClick={migrateV2Cheap} disabled={txInProgress} role="button" style={{ marginBottom: 20 }}>
          ...
          <p style={{margin: '10px 0 20px 0', maxWidth: '75%'}}>
            You have two options to migrate your settlement with the standard {'"Migrate"'} functions upgrading your
            existing settlement to V2. This will keep your existing v1 attributes and port them over to v2.
            Approx gas cost: 730k.
          </p>
          <p style={{margin: '10px 0', maxWidth: '75%'}}>
            Choosing the {'"Migrate & Reroll"'} option is 40% cheaper in gas costs and will reroll your
            settlement into the {'"Shadow"'} realm and give you new attributes. Approx gas cost: 400k.
          </p>
        </div>
